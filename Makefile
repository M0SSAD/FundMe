...
NETWORK_ARGS := --rpc-url http://localhost:8545 --account $(ACCOUNT_ANVIL) --broadcast
...
deploy-sepolia:
	@forge script script/DeployFundMe.s.sol:DeployFundMe --rpc-url $(SEPOLIA_RPC_URL) --account $(ACCOUNT_SEPOLIA) --broadcast --verify --etherscan-api-key $(ETHERSCAN_API_KEY) -vvvv
